...
var LineHeight_LineHeight = function LineHeight(props) {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(common_DropDown, {
    autoHide: true,
    caption: caption || props.defaultCaption || /*#__PURE__*/external_react_default.a.createElement("i", {
...
var ControlBar_ControlBar = /*#__PURE__*/function (_React$Component) {
  ...
  createClass_default()(ControlBar, [{
    ...
    value: function render() {
      ...
      var styleObject = ControlBar_objectSpread(ControlBar_objectSpread({}, style), editor.isFocused ? null : {
        display: 'none'
      });
...
external_draft_js_["EditorState"].createFrom = function (content) {
  ...
  customOptions.unitExportFn = customOptions.unitExportFn || editor_0.defaultProps.converts.unitExportFn; // customOptions.unitImportFn =
  //   options.unitImportFn ||
  //   BraftEditor.defaultProps.converts.unitImportFn;
